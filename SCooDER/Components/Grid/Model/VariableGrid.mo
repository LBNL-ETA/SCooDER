...
model VariableGrid "Variable electrical grid"
  ...
  VariableVoltage_3ph                                                sou(
    ...
    phiSou=phiSou) "Voltage source"
     annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        origin={-10,0})));
  Modelica.Blocks.Interfaces.RealInput V_ext[3](each start=480)
...
equation
  ...
  connect(sou.terminal, terminal) annotation (Line(
      points={{0,6.66134e-16},{0,-100},{4.44089e-16,-100}},
      color={0,120,120},
      smooth=Smooth.None));
  connect(V_ext, sou.Vext) annotation (Line(points={{-120,1.11022e-15},{-72,
          1.11022e-15},{-72,3},{-21,3}}, color={0,0,127}));
  annotation (
